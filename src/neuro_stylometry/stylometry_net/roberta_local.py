...
class RobertaEmbeddings(nn.Module):
    ...
    def forward(
        ...
        # when its auto-generated, registered buffer helps sending to correct device.
...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def forward(
        ...
        # DEBUG: Check if Encoder is the issue by returning Embeddings acting as Encoder output
        # encoder_outputs = (embedding_output,) # Dummy encoder output
...
def create_position_ids_from_input_ids(input_ids, padding_idx, past_key_values_length=0):
    return torch.zeros_like(input_ids) # DEBUG: Dumb static positions
